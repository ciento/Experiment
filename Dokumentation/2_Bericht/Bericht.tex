...
\section{Einleitung}
	...
	Das Thema Zeitempfinden spielt in unserer modernisierten Gesellschaft eine immer wichtiger werdende Rolle. Zwischen Arbeit, Freizeit und Familie ist es wichtig, seine Zeit ganz genau zu planen und jede freie Minute auszunutzen. Aufgrund des Wissens, dass die arbeitende BevÃ¶lkerung sich an bestimmte Zeitregeln hÃ¤lt und versucht den Alltag optimal zu managen und unter Betrachtung der zunehmenden Relevanz von Zeitmanagement und Zeitsparen, richteten wir unsere Forschung auf das Thema der Zeitmanpulation. ZunÃ¤chst gilt zu definieren, was Zeit Ã¼berhaupt ist: â€Zeit ist das Nacheinander von ZustÃ¤nden und Ereignissen, die erlebbar und messbar sind. Sie ist eine physikalische GrÃ¶ÃŸe fÃ¼r die VergÃ¤nglichkeit und VerÃ¤nderungenâ€œ. (\underline{http://definition-online.de/zeit/})
	\par
	In unserer Lebenswelt gibt es bestimmte Zeitgeber, von der Uhrzeit selber einmal abgesehen, die uns Hinweise geben, wieviel Zeit vergangen ist. FÃ¼r uns galt es nun herauszufinden, ob es mÃ¶glich ist, anhand gÃ¤ngiger Zeitgeber, die jeden einzelnen Menschen seit der Geburt tÃ¤glich begleiten, eine Manipulation des Zeitempfindens auszulÃ¶sen. Anhand unserer Forschungsfrage: â€Kann man das Zeitempfinden in der Virtuellen Welt durch bestimmte Zeitgeber manipulierenâ€œ erschufen wir eine Virtuelle Welt, durch die unsere spÃ¤teren Probanden mit Hilfe einer VR-Brille manipulierte Zeitgeber erlebten. 
	\par
	 Wir legten einen weiteren Fokus unserer Arbeit auf die ZeitschÃ¤tzung. Jeder Proband wurde gebeten, vor und nach dem Befinden in der Virtuellen Welt eine bestimmte Sekundenanzahl abzuschÃ¤tzen, ohne auf Hilfsmittel zuzugreifen, wie beispielsweise eine Armbanduhr. Auf diese Weise wollen wir herausfinden, ob sich die ZeitschÃ¤tzung vor dem Befinden in der Virtuellen Welt von der ZeitschÃ¤tzung nach dem Befinden in der Virtuellen Welt unterscheidet.
Dieser Bericht fÃ¼hrt Ã¼ber die Ideenfindung unserer Forschungsschwerpunktes zu unseren Hypothesen. Nach der technischen und kreativen Umsetzung unseres Experiments und unserer virtuellen Welt wird der detaillierte Ablauf des Experiments beschrieben. Im Zweiten Teil- dem empirischen Teil- folgen die Auswertungen, Ergebnisse und Interpretationen und der Bezug zu unseren Hypothesen. Am Ende des Berichts gibt es einen kurzen Ãœberblick Ã¼ber die Zusammenarbeit der Forschungsgruppe und ein abschlieÃŸendes Fazit. 
	\par
	\textit{â€Zeit ist das, was man an der Uhr abliest.â€œ (Albert Einstein)}
	\par
...
\section{Ideenfindung und Hypothese}
	...
	Protokoll fÃ¼r das Meeting am Montag, den 24.04.2017:
Mit der UnterstÃ¼tzung unseres Dozenten haben wir eine grobe Vorstellung davon bekommen, wie unser Projekt aussehen kÃ¶nnte. Um die Erwartungen an dieses Projekt und die Art und Weise wie es durchgefÃ¼hrt werden soll abzudecken, haben wir mit Hilfe des Brainstormings Ideen gesammelt. Dabei war es neben der Ideensammlung wichtig, utopische Vorstellungen nicht sofort zu verwerfen. Durch die Virtual Reality wollten wir beispielsweise Probanden dazu bringen, gegen ihre Phobie, wie die HÃ¶henangst oder die Angst vor Spinnen anzukÃ¤mpfen. AuÃŸerdem wollten wir versuchen, die Probanden in einen â€anderenâ€œ KÃ¶rper zu stecken. Damit ist ein anderes Geschlecht, die Hautfarbe oder Ã¤hnliches gemeint, welches mit einem KÃ¶rper â€“ Tracker realisiert werden kÃ¶nnte. Hierbei lag der Fokus besonders darauf, ob sich die Probanden auch wirklich in einen dieser KÃ¶rper hineinversetzen kÃ¶nnten beziehungsweise ob sich das Gehirn dem anpasst. DarÃ¼ber hinaus hatten wir einen Einfall, dass Probanden in der Virtual Reality einen Superhelden verkÃ¶rpern kÃ¶nnten, denn laut Studien sollen sie durch diese Konfrontation sozialisierter werden. NatÃ¼rlich stellte sich demzufolge die Frage, was passieren wÃ¼rde, wenn man einen Probanden in einen Schurken transformiert. KÃ¶nnte sich das Verhalten ins Negative auswirken? Eine weitere Idee war, Rollstuhlfahrer mit ihren Gedanken eigene Bewegungen steuern zu lassen. Dieser Blickwinkel ist und war allerdings schwer zu realisieren, da Rollstuhlfahrer als Probanden fungieren mÃ¼ssten. Des Weiteren wÃ¤re eine Studie interessant, die aussagt, wie weit Probanden in der Virtual Reality gehen wÃ¼rden. WÃ¤ren sie bereit, Leute in einem Spiel zu liquidieren? Sollte dieser Fall eintreten, wÃ¼rden bei diesen Probanden die Gehirnschwingungen gemessen werden und VerÃ¤nderungen oder Unterschiede notiert. Ideen in diese Richtung wurden aber letztendlich verworfen, da es nicht der Ethik der Wissenschaft entspricht. Eine weitere Idee war, einen bewegenden, emotional ansprechenden Film vor sowie nach dem Befinden in der Virtual Reality abzuspielen, um zu prÃ¼fen, ob sich der Proband nun anders verhÃ¤lt, mitfÃ¼hlender, sensibler, hilfsbereiter oder Ã¤hnliches ist als vorher. FÃ¼r die spÃ¤tere Auswertung sollten einige Werte gemessen und festgehalten werden, wie zum Beispiel die Feuchtigkeit der Haut, der Herzschlag oder die GehirnstrÃ¶me.
\par
Nachdem wir die oben beschriebenen Ideen gesammelt und festgehalten hatten, ging es daraufhin um die Recherche fÃ¼r mehr Input und dem Abgleich, ob schon vorhandene Experimente in die Richtung durchgefÃ¼hrt wurden. WÃ¤hrend dieses Vorgehens kamen uns noch weitere Gedanken. Einer davon war, den Probanden mit Hilfe eines Pinsels am OberkÃ¶rper zu streicheln. An dieser Stelle wird dann in der Virtual Reality Welt genau dieser Pinsel zu sehen sein, welcher ihn streichelt. Passt sich das Gehirn dem an? Der Grundgedanke dabei war, wie sie in einer schnelleren oder langsameren Welt interagieren. Gibt es beispielsweise Unterschiede im Bewegungsablauf oder in der ReaktionsfÃ¤higkeit? Dazu wÃ¤re es wichtig, Reaktionstests durchzufÃ¼hren, Wettrennen, das Laufen in der Virtual Reality, BÃ¤lle zu fangen, Sachen zu sammeln, oder das Laufband schneller beziehungsweise langsamer fÃ¼r die Haptik einzustellen. Um die Welt so realistisch wie mÃ¶glich dazustellen, sollte mit Hand â€“ Trackern gearbeitet und zusÃ¤tzlich die Illusion vom selber sprechen erschaffen werden. DafÃ¼r wird ein Spiegel in die Virtual Reality eingebaut, um den Avatar sprechen zu sehen. AuÃŸerdem sollte es einen Vergleich zwischen Kindern und Erwachsenen geben mit der Frage: â€Gibt es Unterschiede bei Kindern oder Erwachsenen, welches die ReaktionsfÃ¤higkeit nach dem Virtual Reality Experiment betrifft?â€œ. Durch das Einbeziehen aller Ideen haben wir uns schlussendlich auf folgende Forschungsfrage geeinigt: â€Wie verÃ¤ndert sich das Zeitempfinden in der realen Welt auf den Avatar durch einwirkende Zeitraffung bzw. Zeitdehnung in der Virtual Reality?â€œ. Unser Fokus liegt unter Beachtung all dieser Dinge auf dem Zeitempfinden des Probanden. Mit dem Ausbau dieser Idee hatten wir einige Vorstellungen wie die Virtual Reality aufgebaut werden sollte. Wir wollten einige Situationen bieten, wie zum Beispiel: durch die Stadt laufen, eine Welt mit Uhren, Autos, FahrrÃ¤der, Tiere, andere Menschen, BÃ¤ume, HeiÃŸluftballons und die Interaktion mit Probanden, die Aufgaben erledigen sollen. Aufgaben die das Flyer verteilen beinhalten, laufen, BÃ¤lle fangen oder im Schaufenster mit sich reden / sich sehen (â€˜body transfer illusionâ€˜).
\par
Es ist wichtig zu erwÃ¤hnen, dass es drei VR â€“ Welten gibt. Eine langsame, eine schnelle und eine mit einer normalen Zeiteinheit in der die Probanden interagieren mÃ¼ssen. Pro Kategorie sollte es eine aktive und eine passive Interaktion geben. Probanden in der langsamen Welt erledigen Aufgaben, die einen einfachen Schweregrad kennzeichnen, wie das Erkunden der Gegend. Des Weiteren hatten wir die Idee, das Experiment an einem Strand mit unterschiedlichen Sonnenbewegungen durchzufÃ¼hren. Es sollte auÃŸerdem darauf geachtet werden, dass in der schnellen Welt die Sonne schneller untergeht, sprich, dass die ZeitablÃ¤ufe den Welten angepasst werden.
\par
Schlussendlich haben wir uns noch einmal mit unserem Dozenten zusammengesetzt und Ã¼ber unsere bestehende Forschungsfrage nachgedacht. Dabei sind wir zu dem Entschluss gekommen, dass zu viele Tasks das Experiment in die LÃ¤nge ziehen. Aus diesem Grund wurde das Konzept noch einmal Ã¼berarbeitet, was zur Folge hatte, dass sich die Forschungsfrage Ã¤nderte. Die aktuelle lautet nun: â€Kann man das Zeitempfinden in der Virtuellen Welt durch bestimmte Zeitgeber manipulieren?â€œ
...
\section{Verlauf}
	...
	\subsection{Planung/Recherche} % Marvin
		...
		%Erster Kontakt
		Erster BerÃ¼hrungspunkt mit dem Bachelorprojekt Â¡Experiment! war fÃ¼r viele Gruppenmitglieder die Vorstellung eben dessen durch Thorsten KluÃŸ am 24.01.2017 an der Hochschule fÃ¼r KÃ¼nste, bzw. deren Wiederholung am 06.04.2017 an der UniversitÃ¤t Bremen. Erweitert wurde der zweite Termin dabei durch eine FÃ¼hrung der RÃ¤ume des 'Cartesiums', sowie eine Beschreibung der vorangegangen Bachelorprojekte. Hierdurch konnte ein erster Eindruck Ã¼ber die verschiedenen Versuchsaufbauten und ferner der Beschaffenheit unseres Projekts gewonnen werden. An dieser Stelle wurde zunÃ¤chst eine Recherche-Aufgabe zu vorbereiteten Texten ausgeteilt, welche allein oder in kleineren Gruppen bearbeitet und spÃ¤ter prÃ¤sentiert werden sollte.\\
\\
		%Erwartungen
		Am darauffolgenden Termin wurden uns von den Dozenten (Thorsten KluÃŸ und Jaime Maldonaldo, spÃ¤ter zusÃ¤tzlich Kerstin Bub) alle Erwartungen, sowie Schein- und Arbeitsbedingungen dargelegt.\\
\\
		%Social & Arbeitsweise/Zeiten
		Neben den Ã¼blichen 'Kennenlern-Ritualen', wie z.B. dem Herausstellen der eignen StÃ¤rken und SchwÃ¤chen anhand von 'Skill-Profilen', wurden die ersten zwei Wochen der Projektarbeit hauptsÃ¤chlich fÃ¼r technische Organisation, Planungs- und Recherchezwecke genutzt. Dabei entschied man zunÃ¤chst, dass ein 'Scrum'-Modell mit geteilter 'Scrum-Master'-Position fÃ¼r das Projektmanagement genutzt werden soll. Anhand der bereits erwÃ¤hnten FÃ¤higkeitenprofile wurde die Gruppe 7-3 in zwei Teams mit unterschiedlichen Schwerpunkten aufgeteilt('Design' und 'Organisation').\\
		Weiterhin wurde ein umfassender Stundenplan aus den einzelnen StundenplÃ¤nen fÃ¼r das restliche Studium jedes Teilnehmers erstellt. Anhand dessen wurden Zeiten an vier Tagen der Woche ermittelt, welche fÃ¼r Treffen der Arbeitsgruppe zum Bachelorprojekt genutzt werden sollten, mit einem zusÃ¤tzlich Slot am Donnerstag fÃ¼r ein Meeting mit den Dozenten. \\
		Zu Beginn jeden Arbeitstages wurde ein 10-minÃ¼tiges 'Scrum-Treffen' gehalten, in denen anstehende Aufgaben aus dem Backlog und Probleme besprochen wurden. Diese besonderen Treffen wurden jedoch nie regelmÃ¤ÃŸig eingehalten, vor allem in spÃ¤teren, arbeitsintensiveren Phasen nicht.\\
		Ferner wurde fÃ¼r die ProtokollfÃ¼hrung der Treffen eine feste Reihenfolge angelegt.\\
\\
		%Raum
		Leider war es unseren Dozenten nicht mÃ¶glich, eine dedizierten Raum fÃ¼r unseren Arbeitsprozesse zu erhalten, weshalb die Treffen je nach Situation im Konferenzraum 4.43 des vierten Stockwerks oder den RÃ¤umen 4.12 und 4.16 (ebenfalls vierter Stock) im Cartesium abgehalten worden sind. Um Zugang zu der Etage und diesen RÃ¤umen zu gewÃ¤hrleisten, erhielten wir mit einiger VerzÃ¶gerung jedoch TÃ¼rchips fÃ¼r das spezielle SchlieÃŸsystem des Cartesiums.\\
\\
\newpage
		% Tech
		Auch wurden alle technischen LÃ¶sungen zur Arbeitsweise in dieser Zeit implementiert. Als zentrale Sammelstelle fÃ¼r sÃ¤mtliche Dokumente wurde ein Board beim Service 'Trello' genutzt. Dort lieÃŸen sich bequem und zugÃ¤nglich fÃ¼r alle Teilnehmer sÃ¤mtliche wÃ¶chentlichen Sprints sowie der Backlog des Scrum, die Protokolle und der Stundenplan, etc. ablegen. FÃ¼r schnelle Kommunikation untereinander wurde der Nachrichtendienst 'WhatsApp' genutzt, da diese Applikation bereits auf sÃ¤mtlichen EndgerÃ¤ten der Teilnehmer installiert war. Leider wurde dieser Dienst nicht von den Dozenten genutzt und wir verlieÃŸen uns auf Kommunikation per E-Mail mit diesen, sowie Telefonate in dringenden FÃ¤llen.\\
		\begin{figure}[H] % here - top - bottom - page, das ! erzwingt die Position falls mÃ¶glich
			\centering
			\includegraphics[width=\linewidth, height=\textheight, keepaspectratio]{Bilder/20170518_103125.jpg}
			\caption{Das Â¡Experiment!-Team bei der Arbeit}
			\label{img:experiment-team-bei-der-arbeit}
		\end{figure}
		%Recherche
		Die ersten Rechercheleistungen beschÃ¤ftigten sich hauptsÃ¤chlich mit wissenschaftlichen Arbeitsweisen, existierenden technischen MÃ¶glichkeiten und bereits durchgefÃ¼hrter Forschung. Vollkommen fehlgeleitet und geblendet von technischen Besonderheiten wie dem mÃ¶glichen Hand-Tracking durch 'LeapMotion' oder der Bewegungsteuerung durch [die Kugel] versuchten wie eine Forschungsfrage passend zu diesen zu entwickeln.\\
		Wie im 'Paragraphen 2: Ideenfindung' beschrieben, dauerte es eine gewisse Zeit bis wir eine konkrete, realisierbare Forschungsfrage zur Manipulation des Zeitempfindens innerhalb der 'Virtual Reality' ausarbeiten konnten. MaÃŸgeblich geholfen hat uns dabei die Grundlagenforschung zur Zeitwahrnehmung in der VR von Gerd Bruder.\\
\\
		%Ãœberschneidung
		Die genauen Spezifikationen an unser Experiment gemÃ¤ÃŸ der Forschungsfrage wurden nach RÃ¼cksprache mit den Dozenten immer wieder verÃ¤ndert. Hierdurch entstand viel unbenutzbares Material, da wir Ã¼berschneidend bereits damit begonnen hatten, 3D-Objekte nach den ersten Anforderungen fÃ¼r unsere Versuchswelt zu erstellen. Dies geschah fÃ¤lschlicherweise aus dem Versuch heraus, bereits verlorene Zeit aufzuholen, wodurch jedoch nur mehr 'Verschnitt' produziert worden ist, was uns ultimativ uns mehr Zeit gekostet hat.\\
\\
		%WeiterfÃ¼hrend
		Wir approximierten, dass sich ab diesem Zeitpunkt unser Projekt in 3 Phasen (Programmierphase, Versuchsphase, Evaluation/Paper) 	unterteilen lieÃŸe und legten Deadlines fÃ¼r die einzelnen fest. Im Laufe des Projektes sollten wir jedoch erkennen, wie weit entfernt diese EinschÃ¤tzungen von der RealitÃ¤t abwichen.

	\subsection{Design} % Daniel
		\todo{methodisches Versuchsdesign}
		Angefangen haben wir mit dem Erstellen von 3D-Objekten. Aus einer Liste mit benÃ¶tigten Objekten suchte sich jeder aus dem Technikteam einige heraus und begann sie zu designen. Folgende Objekte wurden erstellt, wenn auch nicht alle im finalen Projekt zum Einsatz kamen:
		...
		\begin{itemize}
			...
			\item Sonne
			\item StraÃŸe
			\item StraÃŸenschilder
			\item Supermarkt
			\item Wolken
			\item Zimmerpflanze (Kaktus)
		\end{itemize}
		
		\begin{figure}[!htbp] % here - top - bottom - page, das ! erzwingt die Position falls mÃ¶glich
			\centering
			\includegraphics[height=\linewidth, width=\textheight, keepaspectratio, angle=270]{Bilder/20170606_145921.jpg}
			\caption{ProblemlÃ¶sung in Unreal}
			\label{img:porblemloesung}
		\end{figure}

\newpage
		Die Welt war zuerst als recht groÃŸe Welt geplant, in der man sich frei bewegen kann. Hier sollte man sich viele verschiedene interessante Dinge angucken kÃ¶nnen und frei durch die Gegend laufen. Hierbei stieÃŸen wir jedoch auf das Problem, dass verschiedene Versuchspersonen verschiedene Wege gehen wÃ¼rden und somit unterschiedliche Dinge erleben und manche Szenarien vielleicht sogar komplett auslassen wÃ¼rden. Um dies zu verhindern, kam uns die Idee einer Art Schnitzeljagd. Damit wÃ¤re gewÃ¤hrleistet gewesen, dass jeder Versuchsperson ungefÃ¤hr die gleiche Strecke lÃ¤uft und das gleiche erlebt wie alle anderen. Jedoch stellte sich auch das als nicht sehr praktikabel heraus. Wir benÃ¶tigten ein Mapdesign, in dem jede Versuchsperson die gleiche Strecke lÃ¤uft und das gleiche erlebt.

		So kamen wir darauf, die Versuchspersonen auf einem Gehweg entlanglaufen zu lassen, auf dem es keine betretbaren Abzweigungen gibt und jeder an mehreren Ampeln fÃ¼r eine vordefinierte Zeit warten muss. 
		
		WÃ¤hrend des gesamten Designprozesses kam es immer wieder zu Schwierigkeiten und Problemen.
		
		\subsubsection{Blender}
			Blender ist ein sehr komplexes und umfangreiches Programm, dementsprechend hatte jeder von uns eine lÃ¤ngere Einarbeitungsphase. Bei kleineren Problemen haben wir uns gegenseitig viel helfen kÃ¶nnen und unser angesammeltes Wissen ausgetauscht. Die grÃ¶ÃŸten Probleme entstanden hauptsÃ¤chlich nach dem Import in die Unreal Engine. 

			Ein Problem war, dass bei einigen Objekten die Textur nicht korrekt dargestellt wurde oder Objekte teilweise durchsichtig waren. Bewegt man die Kamera in der Unreal Engine in ein Objekt hinein, so sollte man von innen nach auÃŸen durch die ObjektoberflÃ¤chen hindurch gucken kÃ¶nnen. Die Teile, die von auÃŸen durchsichtig waren, waren von innen jedoch sichtbar. Somit war das Problem, dass die Objekte teilweise \"auf links gekrempelt\" waren. Mit Hilfe des Anzeigens der Normalen in Blender lieÃŸen sich diese FlÃ¤chen aber leicht aufspÃ¼ren und umdrehen bzw. die Normale(n) invertieren.
			
			GrÃ¶ÃŸere Probleme hatten wir auch bei den Texturen. Die Bearbeitungs-Ansicht (Texture) in Blender entsprach nicht immer der in Blender gerenderten Ansicht (Rendered) und auch nicht der in der Unreal Engine angezeigten Ansicht. Somit hatten wir fÃ¼r ein Objekt teilweise drei verschiedene Ansichten der Textur. Am meisten Probleme machten die HÃ¤user, wohingegen andere Objekte wie der American Store vÃ¶llig problemlos funktionierten. Gerade bei den HÃ¤usern haben wir die Materials, in denen die Texturen enthalten sind, in der Unreal Engine noch stark nachtrÃ¤glich bearbeitet.
			Generell wurden nahezu alle Materials in der Unreal Engine nochmal editiert, da Einstellungen wie Specular Lightning oder Spiegelungen nicht von der Engine Ã¼bernommen wurden.
			
			Ein zentrales Problem war, dass jegliche von uns erstellten Objekte nach eine Build des Lightnings komplett schwarz waren. Nach einiger Recherche stellte sich heraus, dass alle in der Unreal Engine verwendeten Objekte zwei UV-Maps benÃ¶tigen. Die zweite ist notwendig fÃ¼r das korrekte Darstellen des Lightning und ist, zumindest bei statischen Objekten, zwingend notwendig. Sich bewegende Objekte wie beispielsweise die Autos werden anders gerendert und benÃ¶tigen diese zweite UV-Map nicht. 
		
		\subsubsection{Unreal Engine}
			Gestartet haben wir unser Projekt mit der VR-Vorlage von Unreal. Mit der Fertigstellung der ersten Objekte fingen wir an die Welt zu bauen. Eine anfÃ¤ngliche Herausforderung war die Skalierung, da man sich in einer fast leeren Welt kaum an etwas orientieren kann. Nach einiger Recherche haben wir eine Skalierung festgelegt und ein groÃŸes Schachbrett mit $1m^{2}$ groÃŸen Feldern als Orientierung unter die Map gesetzt. Mit dessen Hilfe haben wir die StraÃŸen und Gehwege platziert. Weiter ging es mit HÃ¤usern und GÃ¤rten, bis wir schlieÃŸlich die letzten Details wie MÃ¼lleimer, Laternen und BÃ¤ume gesetzt hatten. 
			...
			Nach einiger Zeit stellten wir auch fest, dass es fÃ¼r die Spiellogik einen erheblichen Unterschied macht, ob man die Welt mit der Oculus Rift durchlÃ¤uft, oder \"auf dem Bildschirm\". Beispielsweise wird eine Triggerbox, die man betritt oder verlÃ¤sst, normalerweise nur einmal getriggert. Beim Betreten/Verlassen mit VR-Ansicht hingegen um die zwanzig mal.
		
		\subsubsection{Hardware \& Software}
			Allerlei Hardware hat, gerade am Anfang, aus uns unbekannten GrÃ¼nden oftmals nicht so funktioniert wie erwartet. Das hat uns letzten Endes dazu bewegt auf einem neuen Computer eine frische Installation von Windows 10 mit allen aktuellen Updates aufzuspielen. Nachdem alle Treiber und Programme installiert waren und auch alles funktionierte deaktivierten wir jegliche Updates, um eventuelle negative Ã„nderungen am System zu verhindern. 
			
			AuÃŸerdem haben wir zeitlich etwa mittig im Designprozesses die anfÃ¤nglich gewÃ¤hlte VR-Vorlage in Unreal gegen eine 3rd-Person-Vorlage ausgetauscht. Dies vereinfachte das anschlieÃŸen eines Controllers enorm. Die Einbindung der Virtusphere zur Steuerung stellte sich als zu komplex und zeitaufwendig heraus. 
		
		\subsubsection{FragebÃ¶gen und Versuchspersonen}
			Zeitgleich wurden auch die FragebÃ¶gen entwickelt und ausformuliert. Es gab drei StÃ¼ck (A, B und C), einen fÃ¼r vor dem Betreten der VR-Welt, einen fÃ¼r danach und einen nur fÃ¼r uns.
			
			AuÃŸerdem gab es einen Intelligenztest. Von anfÃ¤nglich einem recht umfangreichen sind wir am Ende zu einem sehr kurzen gewechselt, da wir kein exaktes Ergebnis benÃ¶tigen und den Zeitaufwand fÃ¼r die Versuchspersonen mÃ¶glichst gering halten wollten.
			
			Zuletzt haben wir eine EinverstÃ¤ndniserklÃ¤rung aufgesetzt, die uns rechtlich absichert und jede Versuchsperson unterschreiben musste.
			
			Zeitgleich mit allen Aufgaben des Designprozesses haben wir nach Versuchspersonen gesucht. Hierzu formulierten wir einen Anzeigentext und verÃ¶ffentlichten ihn teilweise mehrfach auf dem schwarzen Brett bei bremen.de, eBay Kleinanzeigen und dem schwarzen Brett in Stud.IP. ZusÃ¤tzlich fragten wir in unserem Bekanntenkreis herum. 
			
			Auf Grund von technischen Schwierigkeiten mussten wir den Start der VersuchsdurchfÃ¼hrung einige Male verschieben und mit betroffenen Versuchspersonen einen alternativen Termin absprechen. 
		
	\subsection{VersuchsdurchfÃ¼hrung} % Daniel
		FÃ¼r die VersuchsdurchfÃ¼hrung benutzten wir meistens zwei RÃ¤ume. Ein Raum war fÃ¼r den VR-Teil des Experiments und einer fÃ¼r die FragebÃ¶gen und Messungen davor und danach. Im Flur vor den RÃ¤umen war ein Wartebereich mit Sofas, Knabbersachen und GetrÃ¤nken. 
		
		In der Zeit der VersuchsdurchfÃ¼hrung waren wir nicht alle gleichzeitig anwesend, sondern immer nur ein im Voraus festgelegtes Team. Es gab eine feste Routine, wie wir mit den Probanden umgehen und was wir ihnen sagen oder auch nicht sagen. 
		
	\subsection{Auswertung} % Marvin
	
		%Auswertung
		Das Projekt abschlieÃŸend folgte nach dem 26.03.2017, dem letzten Tag der VersuchsdurchfÃ¼hrung, die Auswertung unserer Ergebnisse.
		ZunÃ¤chst mussten wir auch in dieser Phase einige zusÃ¤tzliche Recherche, vor allem zu mathematischen Verfahren fÃ¼r statistische Auswertung, betreiben. Ebenfalls sehr wichtig waren fÃ¼r uns die genauen Richtlinien zur VerÃ¶ffentlichung eines wissenschaftlichen Papers. Hierzu erhalten wir ein maÃŸgebendes Buch von unseren Dozenten. Wir unterteilten den Inhalt des Papers und dieses Berichts und teilten diese untereinander auf.\\
		Danach begannen wir zunÃ¤chst damit sÃ¤mtliche Ergebnisse zu digitalisieren.\\
\\

5. Versuchsaufbau & Durchführung

\section{Versuchsaufbau und DurchfÃ¼hrung}
...
Probanden mit Gehirnschäden und psychischen Erkrankungen würden möglicherweise zu einem verfälschtem Ergebnis führen, weshalb die Probanden nach Erkrankungen abgefragt wurden. \\
...
\section{Fazit}
	...
	Zusammenfassung: Was wurde grob in dieser Arbeit gemacht? Was waren die SchlÃ¼sselergebnisse?

	Wem nÃ¼tzen die BeitrÃ¤ge der Arbeit? Inwieweit wird die Wissenschaft durch die Arbeit verbessert?

	Aufbauende Arbeiten: Welche mÃ¶glichen LÃ¶sungsansÃ¤tze fÃ¼r noch bestehende Probleme sind denkbar(mehr Probanden)? Wie kÃ¶nnten Folgearbeiten aussehen?

\section{AbschlieÃŸende Gedanken}
	\todo[inline]{Autor: Jana}
	Wir sind in den verschiedenen Phasen des Projekts auf unterschiedliche Probleme gestoÃŸen, von denen wir viele zeitnah lÃ¶sen konnten. Allerdings gab es auch schwerwiegendere, deren LÃ¶sung fÃ¼r uns nicht gleich oder gar nicht offensichtlich war und die unseren ursprÃ¼nglichen Zeitplan infolgedessen ungewollt stark beeinflusst haben.\\
	Eines der grÃ¶ÃŸten Hindernisse in unserem Projekt waren technische Probleme, die ein Vorankommen sehr stark verzÃ¶gerten und in einem verÃ¤nderten Zeitplan resultierten.\\
	Durch die InkompabilitÃ¤t der Ocolus Rift und dem Computer der Virtusphere konnten wir unser Projekt nicht wie ursprÃ¼nglich geplant in der Virtusphere stattfinden lassen und mussten auf herkÃ¶mmliche Controller ausweichen. Diese Umstellung ist sehr Ã¤rgerlich, da viel Zeit in die ProblemlÃ¶sung investiert wurde und wir den Probanden letztendlich doch nicht das bieten konnten, mit dem wir sie ursprÃ¼nglich geworben haben. 
	Weiterhin zu kritisieren wÃ¤re eine nicht ganz ideale Arbeitsteilung, wodurch es gerade am Ende zu erheblichem Zeitverzug kam. Insbesondere das sog. \textit{Technikteam}, welches primÃ¤r fÃ¼r die Erstellung der Blenderobjekte, das Einsetzen und das Animieren der Welt verantwortlich war, hat gleich zu Beginn des Projekts anstehende Aufgaben nicht sinnvoll verteilt. Alle Mitglieder waren gleichermaÃŸen nur mit \textit{aktuellen} Aufgaben beschÃ¤ftigt. D.h., dass zunÃ¤chst alle fÃ¼r die Erstellung von Blenderobjekten verantwortlich waren und so KapazitÃ¤ten und Zeit verschwendet wurde, da sich bisher noch keiner besonders gut mit der Software auskannte und sich alle gleichermaÃŸen neu einarbeiten mussten.\\
	Diese Entscheidung mag daraus resultieren, dass wir im Bezug auf so eine Art von selbstorganisierter Arbeit sehr unerfahren sind und es dadurch zu FehleinschÃ¤tzungen kam.\\
	Im Nachhinein stellen wir weiterhin fest, dass es fÃ¼r das Projekt besser gewesen wÃ¤re, hÃ¤tten wir zu Beginn andere PrioritÃ¤ten festgelegt. Da die Logik der Welt der Punkt ist, von dem die Ergebnisse abhÃ¤ngen, hÃ¤tte man sich zuallererst auch mit dieser beschÃ¤ftigen mÃ¼ssen bzw. rechtzeitig die Personen bestimmen mÃ¼ssen, die die Hauptverantwortung fÃ¼r diese Ã¼bernehmen.\\
	Auch diese FehleinschÃ¤tzung zeigte sich im Nachhinein als kritisch.
