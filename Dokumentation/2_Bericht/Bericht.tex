...
Jeden Durchgang haben wir mit einer F�hrungg in den Räumlichkeiten begonnen. Der erste Teil, der theoretische Teil des Experiments, findet in unserem Experiment-Befragungsraum, \glqq Raum 1\grqq{} statt. Es sind immer zwei Versuchsleiter (VL), die den ersten Teil des Experiments durchführen und dem Probanden gegenüber am Tisch sitzen. Die Arbeit wird geteilt, sodass einer VL den Ablauf leitet und der zweite VL die Ergebnisse notiert und auf Fehler achtet. Alle Ergebnisse der Zeiteinschätzungen und die Körpertemperatur werden von dem VL auf dem vorgedruckten \glqq Fragebogen B\grqq{} notiert. Die Versuchsperson erh�lt noch keine Einsicht in ihre Ergebnisse, alle Daten werden verdeckt aufgeschrieben.
...
\glqq Wir werden nun einen Zeit-Einschätzungs-Test durchführen, indem Sie 40 Sekunden abschätzen sollen. Dabei dürfen Sie sich nicht unterhalten und sollten Sie eine Armbanduhr tragen, bitten wir Sie diese abzunehmen.  Bei \glq Los \glq{} geht es los und wenn Sie das Gefühl haben, dass 40 Sekunden vergangen sind, sagen Sie bitte \glq Stop\grq{} \grqq{}. Das Ergebnis wird von einem VL notiert.

Das Ergebnis wird von einem der anwesenden VL anhand einer Stoppuhr gemessen und auf dem \glqq Fragebogen B\grqq{} erfasst. Der Proband bekommt den \glqq Fragebogen A\grqq{} ausgehändigt:
...
Daraufhin wird der \glqq Mehrfachwahl-Wortschatz-Intelligenztestgrqq{} (MWT-B) durchgeführt (weitere Erläuterungen unter \glqq Fragebögen\rqq{}). 
...
Der Proband wird in den isolierten und schallgeschützen \glqq Raum 2\grqq{} geführt, wo der praktische Teil des Experiments stattfindet. Dort warten die zwei Versuchsleiter von der VR. Währenddessen werten die ersten beiden VL den Intelligenztest aus.  \\
