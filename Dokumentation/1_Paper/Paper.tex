...
Das Ziel der Arbeit ist es, die zuvor genannten Hypothesen zu belegen bzw. zu widerlegen und somit, unter anderem, herauszufinden, ob man die Zeitwahrnehmung einzelner Menschen mit Hilfe der Manipulation von Zeitgebern ver�ndern kann. Mit Hilfe der virtuellen Welt war dieses Experiment f�r uns umsetzbar und die Frage bleibt offen, ob man eine solche Zeitmanipulation auch in der realen Welt durchf�hren k�nnte. Das Belegen der Hypothesen w�re ein wichtiger Wegweiser f�r weitere Forschungen in diese Richtung.\\
Das Ziel dieser Arbeit ist es nicht, dieses Forschungsfeld abzuschlie�en, sondern versucht nur, es anzusto�en und Freiraum f�r weitere Experimente zu schaffen. Des Weiteren versucht diese Forschungsarbeit ein Themenfeld zu erkunden, indem bisher wenig geforscht wurde. Die Virtuelle Welt ist etwas Neues und Modernes und es existieret eine geringe Anzahl solcher Experimente und Forschungen, vor allem in Bezug auf die Wahrnehmungsver�nderung des Individuums. Schlie�lich w�re die F�higkeit der Zeitmanipulation ein sehr entscheidende und interessante M�glichkeit f�r Ver�nderungen im Alltagsleben der zuk�nftigen Gesellschaft, sei es durch noch mehr Zeitgewinn oder effizientere Zeitnutzung. So k�nnte man nicht nur Stress und Burn-Out reduzieren, sondern eventuell auch mehr Zeit f�r Freizeit und Familie schaffen? Ob diese Zukunftsidee �berhaupt realistisch und umsetzbar ist, sprengt den Rahmen dieser Arbeit und gilt es von weiteren interessierten Forschern zu erkunden.
