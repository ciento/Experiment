...
Das Ziel der Arbeit ist es, die Hypothesen zu be- oder widerlegen. Das Belegen der Hypothesen wäre ein wichtiger Wegweiser für weitere Forschungen in diese Richtung.\\
...
\section{Methode}
 ...
 Die Untersuchung menschlichen Verhaltens mit dem Ziel Forschungsergebnissen zu gewinnen kann ethisch bedenklich sein. Besonders wenn die Manipulationen die Persönlichkeit eines Menschen langfristig prägen oder beeinflussen. Deshalb wurde sich bei der Themenwahl strickt an die ethischen Richtlinien gehalten, um die Sicherheit der zu testenden Personen zu gewährleisten. 
        Die Versuchspersonen wurden im Vorfeld weitestgehend über         Zweck, Ablauf des Verfahrens und den zu erwartenden Nutzen informiert und über die vorhersehbaren Unannehmlichkeiten und Risiken aufgeklärt. Es bestand jederzeit die Möglichkeit das Experiment abzubrechen.
...
Das Projekt wird mit insgesamt 48 Versuchspersonen \textbf{was is tmit den ausgeschlossenen} unterschiedlicher akademischer Grade und Berufe  durchgeführt, wobei 35 männlich und 13 weiblich sind und sich im Alter zwischen 18 \textbf{oder 17?} und 80 Jahren befinden. 
Die insgesamt 24 verschiedenen Reihenfolgen der Szenarien können mit dieser Anzahl an Versuchspersonen realisiert werden, sodass jeweils zwei Versuchspersonen eine konkrete Reihenfolge erleben.\\
Alle Versuchspersonen haben nach eigenen Angaben normale oder mit Brille bzw. Kontaktlinsen auf
                normal korrigierte Sehkraft und normales Farbsehen. Personen mit
                psychischen Erkrankungen, Gehirnschäden oder schlechten Deutschkenntnissen wurden nicht für das Experiment aufgenommen. Die Versuchspersonen waren bezüglich der experimentellen Hypothesen unwissend
                und unterschrieben vor der Teilnahme eine schriftliche Einverständniserklärung über alle
                Risiken und datenschutzrechtlichen Informationen.
                Von der Endauswertung ausgeschlossen wurden zwei Personen, welche aufgrund von Übelkeit und
                Schwindel das Experiment vorzeitig beenden mussten.\\
               Es wurde keine Entschädigung angeboten. 
                \footnote{$()$} \todo{Wozu ist die Fußnote?}
        ...
        \subsection{Apparaturen}
         ...
         (1) Einverständniserklärung, (2) \glqq Fragebogen B\grqq, (3) \glqq Fragebogen A\grqq, (4)
                ...
                vorbereitet. \\
                Im zweiten Raum fanden die VR-Experimente statt, in dem die Versuchsperson auf einem Drehstuhl saß.(TODO)
...
%Da alle Durchläufe der Versuchspersonen einheitlich waren, war unsere Messmethode ergiebieg.



\subsubsection{Theoretischer Teil vor der VR}
Jeder Durchlauf begann mit einer Einweisung durch die Räumlichkeiten. Der erste Teil des
Experiments fand in einem separaten Theorieraum "`Raum 1'' statt. Der Versuchsleiter und
...
"`Mehrfach-Wortschatz-Test (MWT-B)'', entwickelt von Siegfried Lehrl \cite{MWT-B}, den wir nach Empfehlungen des
Psychologie Studenten Till Rachwitz, der sich auf die Durchführung von Intelligenztests
spezialisiert hat, gewählt haben. Dieser begründete die Wahl dieses Tests damit, dass er simpel und kurz
durchzuführen ist. Er bietet einen groben Überblick über die allgemeine Intelligenz
einzelner Personen. Im MWT-B gilt es aus 37 Wortreihen,
...
Anschließend wurde die Körpertemperatur des Probanden mit Hilfe des Infrarot-Thermometers am Ohr gemessen und anschließend ein 30 Sekunden
...
notiert. Der Proband hatte keine Einsicht in die Ergebnisse.

\subsubsection{Praktischer Teil in der VR}
...
Die Umgebung sollte für spätere Befragungen einprägt werden .//

Zu Beginn des Experiments wurde die Zeit von dem Moment des Loslaufens bis zu dem 'Road Closed' Schild gestoppt, um zu wissen wie lange die Versuchsperson für die
gesamte Strecke der vier Szenarien benötigt.
Die insgesamt vier Szenarien bildeten die
virtuelle Welt und bestanden aus vier Ampelkreuzungen, die der realen
Welt durch visuelle und auditive Aspekte nachgebraut wurden.
...
\subsubsection{Theoretischer Teil nach der VR}
...
Für unser Experiment war es ein wesentlicher Bestandteil, dass die Probanden keinen Unterschied bemerken, wenn sie durch die Teleporter(erklären) von einem Szenario zum nächsten teleportiert wurden. Daher musste unsere Versuchswelt so konzipiert werden, dass jede Ampelkreuzung gleich aussieht. Die Teleporter wurden so platziert, dass sich die Triggerbox(erklären), durch die die Versuchspersonen gingen, direkt nach dem Szenario, also nach der jeweiligen Ecke befindet und die Versuchsperson nicht um die nachfolgende Ecke schauen konnte.\\
\\
Die Zeitwahrnehmung sollte durch visuelle und auditive Zeitgeber manipuliert werden. In zwei der Szenarien (\textbf{c}, \textbf{d}) befand sich ein Kind auf einer Schaukel, das jeweils langsam (\textbf{d}) oder schnell (\textbf{c}) schaukelte und so die Zeitempfindung der Versuchspersonen durch verlangsamte oder beschleunigte Gravitation manipulieren sollte. Die Versuchspersonen hatten während der Wartezeit an der Ampelkreuzung etwas zu sehen und wurden voraussichtlich beeinflusst. Die Wartezeit an jeder Ampelkreuzung beträgt 18 Sekunden und wurde duch eine Triggerbox ausgelöst, durch die die Versuchsperson läuftt. \\
Die auditive Manipulation stellte ein gleichmäßiges Ticken an zwei weiteren Szenarien (\textbf{a}, \textbf{b}) dar.
Dies sollte ebenfalls das Zeitempfinden der Versuchspersonen manipulieren. Während die Versuchspersonen an der roten Ampel warten und ein schnelles Ticken (\textbf{a}) hören, sehen sie zusätzlich einen großen LKW neben sich stehen, der dazu verhelfen soll, dass sich die Versuchsperson hinterher an das Szenario besser erinnern.
...
\\
        ...
        \subsection{Begründung der Wartezeiten und Zeitabschätzungen}
                Die Wartezeit jedes Szenarios beträgt 18 Sekunden und basiert auf zuvor gemessenen realen Ampelzeiten. Die Wartezeit ist einerseits kurz genug, sodass bei den Versuchspersonen keine Ungeduld hervorgerufen wird und andererseits lang genug, dass die Versuchspersonen die Möglichkeit haben sich von ihrer Umgebung beeinflussen zu lassen. 
...
In der Zeitspanne $+/-$ 10 Sekunden der angestrebten Zeit befinden sich die meisten der Versuchspersonen mit ihren Einschätzungen, allerdings gibt es sowohl bei der 40- als auch bei der 30-Sekundenschätzung in nahezu jeder Alterskategorie Ausreißer. Aus diesen Diagrammen kann man schließen, dass es keine altersspezifischen Vor- oder Nachteile in einer Zeiteinschätzung gibt.
\todo{prozentsatz}
