...
\begin{figure}[H]
    \subfigure[Ampelphase an einem LKW]{\includegraphics[width=0.5\textwidth]{a.png}}
    \subfigure[Ampelphase mit Vogel und
Menschen]{\includegraphics[width=0.5\textwidth]{b.png}}
%\caption{Titel unterm gesamten Bild}
\end{figure}

\begin{figure}[H]
    \subfigure[Ampel neben einem schaukelndem Kind mit rosa Shirt]{\includegraphics[width=0.5\textwidth]{c.png}}
    \subfigure[Ampel neben einem schaukelndem Kind mit
grünem Shirt]{\includegraphics[width=0.5\textwidth]{d.png}}
%\caption{Titel unterm gesamten Bild}
\end{figure}
