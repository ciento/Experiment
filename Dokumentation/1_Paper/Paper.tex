...
18 Sekunden ist die optimale Dauer für unser Experiment, da es die Probanden einerseits ungeduldig macht wann und wie es nun weiter geht und andererseits die Möglichkeit bietet sich drauf einzustellen jetzt erst einmal warten zu müssen und somit den Effekt erzielt, dass sich die Testpersonen in der Versuchswelt umsehen und die oben genannten Szenarien (a, b ,b c) entdecken, die die Empfindung der Wartezeit beeinflussen sollen.
...
\end{figure}
\par
Die zeitlichen Einschätzungen bezüglich der Längen der einzelnen Szenarien sind als ermittelte Durchschnittswerte im obigen Balkendiagramm je Szenarium dargestellt. Hier zu erkennen ist nun, dass das Szenarium \textbf{d} mit durchschnittlichen 13 Sekunden als das Längste eingeschätzt wurde. Knapp dahinter liegt \textbf{b} mit 12,5 Sekunden, gefolgt von \textbf{a} mit 6,5 und \textbf{c} mit 7 Sekunden durchschnittlicher Schätzung.
...
Die Wertespanne beginnt unten mit 152 Sekunden, umgerechnet sind das ca. 2,5 Minuten und endet oben mit 399 Sekunden oder auch als Minutenwert, 6,65. Die ersten größeren zeitlichen Sprünge lassen sich im Bereich der oberen zwölf Probanden beobachten, insbesondere hinsichtlich der ersten beiden. Der Wertebereich $[165-330]$ aus der vorherigen Abbildung 19 ist auch in das hier betrachtete Diagramm inkludiert. Somit sind abgesehen davon, dass es sich hier um weitaus mehr Beteiligte handelt, keine sonderlichen Verschiedenheiten zwischen den beiden Varianten bemerkbar.
...
\par
Entsprechend der Annahme, dass die Zeit schneller vergeht wenn man Spaß empfindet, müssten also in der Abbildung 14 die meisten Personen \textbf{b c d a} als Reihenfolge mit aufsteigender Dauer gewählt haben. Gemäß der Abbildung 13 hat die Mehrzahl die Reihenfolge \textbf{b a d c} gewählt. \textbf{b} und \textbf{d} stimmen in beiden Möglichkeiten überein, \textbf{a} und \textbf{c} sind vertauscht. In diesem Fall lässt sich also die Annahme nicht genauestens belegen. Auch in den weiteren Reihenfolgen der Abbildung 13 lässt sich das gesuchte Muster, dass der Spaß einen beeinflussenden Faktor darstellt, im Rahmen unseres Experiments nicht eindeutig erkennen.
...
-- damit vergleichen, wie die Zeit in der VR wirklich eingeschätzt wurde
