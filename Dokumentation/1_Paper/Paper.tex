...
\textit{linke seite: erste zeiteinschätzung (40 sek) ohne gespräch. rechts: zweite zeiteinschätzng (30sek) ohne gespräch. helle kreise: frauen, dunkle kreise: männer}
...
Entgegen unserer Hypothese stellen wir fest, dass sich dieses Muster in der Abbildung 1(ZENTRUM) nicht bewahrheiten lässt, da z.B. Szenarium a als längerer eingestuft wurde. Dementsprechend hat der Spaßfaktor, im Rahmen unseres Projekts, keinen verkürzenden Einfluss auf die Zeitwahrnehmung.
...
Zu Abb. x: Nach dem Aufenthalt der Probanden in der VR-Welt wurden diese nach ihrem Spaßempfinden befragt. Dieses Ergebnis kann damit erklärt werden, dass die gewählten Zeitspannen letztendlich nicht mehr auf unser Experiment, das zwischenzeitlich noch stark umgebaut wurde, passten. Geschickter wären kleinere Zeitspannen (0-2 Minuten, 3-4 Minuten,...) gewesen.\\
Unsere Vermutung vor dem Experiment war es, dass die Zeit gefühlt schneller vergeht, wenn man gerade etwas Positives erlebt (Quelle zitieren). Diese Hypothese lässt sich durch unsere Ergebnisse nicht belegen, da der Anteil der Probanden beider Gruppe, die die Dauer im korrekten Zeitfenster geschätzt haben, bei gerundeten 71 Prozent liegt. Dies ist ein weiterer Anhaltspunkt für die bereits erwähnten unpassend gewählten Zeitspannen.\\
