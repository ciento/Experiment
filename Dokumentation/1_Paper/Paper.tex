...
\par
Eine weitere Studie, die uns wichtige, zu beachtende Faktoren zur Zeitmessung vorgab, ist Pascal Wallisch's wissenschaftlicher Bericht „Zeiterleben in der Tempogesellschaft“. $(http://www.lascap.de/Downloads/Zeiterleben_in_der_Tempogesellschaft.pdf)$ \\
...
Für unser Experiment benötigten wir 48 Probanden, da wir vier Szenerien mit unterschiedlichen Reihenfolgen realisierten wollten, die zweimal durchlaufen wurden. Diese zufällige Reihenfolge konnten wir mit der Programmierung eines Teleporters realisieren ( Siehe Kapitel 2 „Methodik“). Das Experiment wurde an 8 Tagen mit jeweils 8 Probanden durchgeführt. Zusätzlich erhielten wir noch Probanden, die sich spontan entschieden haben teilzunehmen, sei es durch Freundschaften mit anderen Probanden oder ähnliches. So hatten wir an einigen Tagen sogar 13 Probanden. Das Experiment begann für die Experimentatoren um 9 Uhr morgens mit dem Aufbau der Räumlichkeiten, des Proviants und des technischen Equipments und endete um 18:30 Uhr nach dem Abbau des Proviants und des technischen Equipments. 
\par
Fragebogen A wurde vor dem Befinden in der Virtuellen Welt verteilt und ging auf die von Wallisch’s beschriebenen Faktoren ein und stellte sicher, dass der Proband weiterhin am Experiment teilnehmen möchte. Zuvor musste noch eine Einverständniserklärung zur freiwilligen Teilnahme am Forschungsexperiment unterschrieben werden. Eine erste Zeitschätzung von 40 Sekunden folgte nach Ausfüllen des Fragebogens A. Diese Ergebnisse werden nach und nach in den Fragebogen B eingetragen. Dieser ist nur wichtig für die Festhaltung der Messergebnisse und der später gemessenen Körpertemperatur und wird nur von den Experimentatoren ausgefüllt. Danach folgte ein Intelligenztest, der „Mehrfach-Wortschatz-Test (MWT-B)“, den wir aus der Testothek der Universität Bremen ausliehen, nach Empfehlungen eines Psychologie Studenten, der sich auf die Durchführung von Intelligenztests spezialisiert hat. Dieser begründete die Wahl dieses Tests damit, dass er simpel und kurz durchzuführen ist und einen groben Überblick über die allgemeine Intelligenz einzelner Personen messen kann. Zwar geht er nicht auf einzelne Schwerpunkte wie Logik, Mathematik, Psychologie etc. ein, erhält aber einen groben Überblick über den IQ und der fluiden, also der im Laufe des Lebens erlernten, Intelligenz. Hierbei stehen pro Zeile fünf verschiedene Wörter zur Auswahl, von denen nur ein Wort existiert. Die anderen vier Wörter sind fiktiv und können dem realen Wort ähneln. Der Proband muss nun in jeder Zeile das reale Wort erkennen und einkreisen oder durchstreichen. $(http://korsakow-syndrom.de/node/80)$ Nun wird der Proband erneut gebeten, 40 Sekunden Zeit abzuschätzen, diesmal mit Unterhaltung. Die Ergebnisse werden in Fragebogen B eingetragen.  Nun wir die Körpertemperatur mit einem Thermometer der Firma „braun“ gemessen. \begin{comment}$(https://www.amazon.de/Braun-ThermoScan-Infrarot-Ohrthermometer-IRT6520/dp/B00NVMIO02/ref=sr_1_1?ie=UTF8&qid=1500012016&sr=8-1&keywords=braun+thermometer)$\end{comment} Für jeden Probanden wurden neue Aufsätze benutzt. Eine weiterer 30-Sekunden Zeitabschätzungstest folgt, bevor der Proband in einen separaten Raum gebracht wird, wo der Virtual-Reality Teil des Experiments beginnt. Für den ersten Teil wurden circa 30-40 Minuten benötigt und zwei Experimentatoren, die den Ablauf vorgaben und für Fragen zur Verfügung standen. 
\\
Das Befinden in der Virtuellen Welt umfasst eine Zeitspanne von circa 3-7 Minuten, zuvor hat jeder Proband die Möglichkeit eine Pause zu machen.\\
 Dem Probanden wird die VR-Brille „Occulus Rift“ aufgesetzt und Kopfhörer, um komplett in der VR-Umgebung integriert zu sein. Während des gesamten VR-Experiments befindet er sich auf einem Drehstuhl und hat so die Möglichkeit, sich in alle Richtungen zu drehen. Vor ihm befindet sich ein Bildschirm, auf dem die Unreal-Umgebung zusätzlich zu sehen ist. Der Proband kann sich in der virtuellen Welt über einen Controller nach vorne, nach hinten oder zur Seite bewegen. Seinen Kopf kann er entweder mit der Occulus Rift oder ebenfalls mit dem Controller bewegen. Nach Einweisung des Probanden kann das Experiment starten. In diesem Raum befinden sich außer dem Probanden noch zwei Experimentatoren, die auch dafür verantwortlich sind, die Zeit zu messen, um zu überprüfen, ob die in Fragebogen C abgefragte empfundene Dauer in der VR mit der realen Dauer in der VR übereinstimmt. Des Weiteren sollen sie den Probanden alle Fragen beantworten und sicherstellen, dass ihnen nicht unwohl wird.  
Schließlich folgt die letzte Phase des Experiments: Die Probanden werden zurück in den ersten Raum gebracht und müssen nochmals 40 Sekunden Zeit abschätzen. Die Ergebnisse werden in Fragebogen B eingetragen. Nun erhält der Proband Fragebogen C und muss diesen bearbeiten. Hier werden die Eindrücke, die der Proband in der Virtuellen Umgebung erhielt, abgefragt und auf sein Zeitempfinden eingegangen. Nach Bearbeitung dieses Fragebogens folgen zwei weitere Zeiteinschätzungstests: 40 Sekunden mit Unterhaltung und 30 Sekunden ohne Unterhaltung. Abschließend wird sich bei dem Probanden für seine Teilnahme bedankt und er wird verabschiedet. Die letzte Experimentphase umfasst eine Zeitspanne von circa 15 Minuten und somit hat das Experiment eine ungefähre Zeitdauer von etwa einer Stunde pro Proband. 
...
-- Diagramme Probandenalter: Korrelation Alter-Zeiteinschätzung bei 40 sek berechnen: bei 'ältere' Probanden eher niedrigere Einschätzung?
-- 'Notlösung': erklären, was zu Beginn unsere Vermutung war (eventuell Bezug auf passendes Paper) und überlegen, warum unsere Ergebnisse anders ausfallen/was verbessert werden könnte
