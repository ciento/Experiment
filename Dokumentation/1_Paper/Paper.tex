...
\begin{minipage}[t]{0.49\linewidth}
	...
	\caption{Welches war das kürzeste Szenario?}
\end{minipage}
%\end{figure}
\hfill
%\begin{figure}[H]
\begin{minipage}[t]{0.49\linewidth}
	...
	\caption{Welches war das längste Szenario?}
	\label{SzenarienLang}
\end{minipage}
\end{figure}
...
Durch die akustischen Zeitgeber haben \textbf{x prozent} Szenario \textbf{a} kürzer eingeschätzt als Szenario \textbf{b}. Bei den visuellen Zeitgebern gibt es eine weniger eindeutige Meinung und das tatsächlich kürzere Szenario \textbf{c} haben nur \textbf{x prozent} erkannt.bab
