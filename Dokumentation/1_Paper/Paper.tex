...
\tikzset{lines/.style={draw=white},}
\pie[pos={8,0},radius = 2, color={redOfDisapproval!40, greenOfApproval!60},sum=auto, after number=,text=legend,every only number node/.style={text=black},style={lines}]{25/d kürzer als c,22/c kürzer als d}
\end{tikzpicture}
